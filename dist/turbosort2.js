...
var turbosort2 = function () {
    ...
    function turboSortHelper(array, offset, length) {
        ...
        for (var _i = 0; _i < length; _i++) {
            while (Module.HEAPU32[offset + _i] !== _i) {
                var dest = Module.HEAPU32[offset + _i];
                //swap i and dest
                swap(array, _i, dest);

                var temp = Module.HEAPU32[offset + _i];
                Module.HEAPU32[offset + _i] = Module.HEAPU32[offset + dest];
...
//# sourceMappingURL=turbosort2.js.map